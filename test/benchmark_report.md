...
Note: CSV layout time _decreases_ with more messages because with 32 messages all fit in 1 chunk (all 64 slots processed), while at 6000 messages only the visible ~3 chunks are processed.
