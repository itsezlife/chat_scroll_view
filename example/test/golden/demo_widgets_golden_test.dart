...
Widget _box({required Widget child, double width = 400, double height = 120}) =>
    MaterialApp(
...
void main() {
  group('demo widget goldens', skip: _platformSkip, () {
    ...
    testWidgets('shimmer placeholder', (tester) async {
      await tester.pumpWidget(_box(child: const DemoShimmerBubble()));
      await tester.pumpAndSettle();
      await expectLater(
    ...
    testWidgets('chunk-error tile (first attempt)', (tester) async {
      await tester.pumpWidget(
        _box(
          height: 80,
          child: DemoChunkErrorTile(firstId: 192, lastId: 255, onRetry: () {}),
        ),
      );
      await tester.pumpAndSettle();
      await expectLater(
    ...
    testWidgets('empty state', (tester) async {
      await tester.pumpWidget(_box(height: 200, child: const DemoEmptyState()));
      await tester.pumpAndSettle();
      await expectLater(
    ...
    testWidgets('initial loading skeleton', (tester) async {
      await tester.pumpWidget(
        _box(height: 600, child: const DemoInitialSkeleton()),
      );
    ...
    testWidgets('date separator pill', (tester) async {
      await tester.pumpWidget(
        _box(height: 56, child: DateSeparator(date: DateTime(2026, 5, 29))),
      );
      await tester.pumpAndSettle();
      await expectLater(
