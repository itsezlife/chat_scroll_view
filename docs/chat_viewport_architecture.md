...
headers, navigation, animation writer ownership, function catalog, and known
limitations.

ID and position policy remain in:

- [docs/adr/001-message-id-scheme.md](adr/001-message-id-scheme.md)
- [docs/adr/002-position-model.md](adr/002-position-model.md)
