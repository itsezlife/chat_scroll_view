...
**Status**: Superseded by [ADR 016](016-cross-platform-message-menu.md)  
**Date**: 2026-08-19
...
**Supersession note:** ADR 016 keeps host-presented chrome and the session/presence/back invariants, but replaces the bare tuple seam with a **message menu request**, adds **secondary message tap** / **over-selection**, and introduces policy-default **message menu presentation** (desktop popup without scrim).
