...
echo "    Launch Flutter from example/:"
echo "      macOS / iOS Simulator:  (cd example && flutter run --dart-define-from-file=../config/development.supabase.json)"
echo "      Android emulator:       (cd example && flutter run --dart-define-from-file=../config/development.supabase.android.json)"
echo "      Android USB device:     (cd example && flutter run --dart-define-from-file=../config/development.supabase.android.device.json)"
echo ""
